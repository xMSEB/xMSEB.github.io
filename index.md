...
We also provide an interactive web-based demo at [**xmseb.github.io/demo/**](/demo/).
...
Dataset: [Jazz Musicians Network](https://doi.org/10.1142/S0219525903001067)

{% include graph-viewer.html
    src="/viewer.html"
    data="/graphs/jazz.json"
    thumbnail="/thumbnails/jazz_xmseb.jpg"
    mode="mseb"
    edge_color="1565c0"
    wide=true
    max_width="40%" %}
...
Dataset: [IEEE SciVis Contest 2023 - Dataset of Neuronal Network Simulations in the Human Brain (brain_bundle_2)](https://doi.org/10.5281/zenodo.10519411)

{% include graph-viewer.html
    src="/viewer.html"
    data="/graphs/neurons2.json"
    thumbnail="/thumbnails/neurons2_xmseb.png"
    mode="mseb"
    edge_color="1565c0"
    wide=true
    max_width="40%" %}
...
## Interactive Comparisons - xMSEB vs. MSEB

Dataset: [EuroSiS](https://gephi.wordpress.com/2008/09/29/euro-sis-map/)

<div style="margin-left: calc(-50vw + 50%); margin-right: calc(-50vw + 50%); width: 100vw; max-width: 100vw; display: flex; align-items: center; justify-content: center">
    {% include comparison.html before="comparisons/eurosis_xmseb.png" after="comparisons/eurosis_mseb.png" label_before="xMSEB" label_after="MSEB" %}
</div>

<div style="margin-left: calc(-50vw + 50%); margin-right: calc(-50vw + 50%); width: 100vw; max-width: 100vw; display: flex; align-items: center; justify-content: center">
    {% include comparison.html before="comparisons/eurosis_xmseb.png" after="comparisons/eurosis_xmseb_directed.png" label_before="xMSEB (Undirected Edges)" label_after="xMSEB (Directed Edges)" %}
</div>
